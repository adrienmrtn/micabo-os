export const en = {
  translation: {
    ...
    simPapier: {
      ...
      subtitle:
        "Draw an unused FR master in ONE CM account’s language, as a test. Hidden from calendars.",
      compte: "CM account",
    ...
    papier: {
      title: "CM paper",
      subtitle:
        "Library of complete FR masters (voice + karaoke). Other languages are created at midnight, only if a CM account exists.",
      aujourdHui: "Master in progress",
      aujourdHuiAide:
        "Advance pipeline prepares an FR master for the library — not tonight’s slot. At midnight each CM draws a master not yet used in their language.",
      aucunAujourdhui: "No master in progress. Start one for the library.",
      topic: "Topic",
      topicPh: "Leave empty to have a topic proposed automatically.",
      generer: "Advance pipeline",
      avancer: "Advance pipeline",
      relancer: "Retry (keep assets)",
      regenerer: "Regenerate from scratch",
      historique: "Library",
      biblioAide:
        "Complete FR masters (script, clips, voice, karaoke). At midnight each CM draws a master not yet used in their language.",
      vide: "No FR master in the library yet.",
      enBiblio: "In library",
      languesDemande: "Languages created at assignment",
      videoFr: "FR video",
      consommees: "Already used: {{langues}}",
      aucuneConso: "Not yet given to a CM",
      ...
      assigner: "Assign now (midnight)",
      assignerAide:
        "Each active CM draws a master not yet used in their language. Missing voice is generated then. If none left: an original starts.",
