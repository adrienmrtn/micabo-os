  ...
  translation: {
    ...
    ugc: {
      ...
      videos: {
        ...
        cropAide:
          "Cut start and end. The cut is an MP4 stream-copy (same FPS/quality as TikTok). The full video is temporary only.",
        ...
        cropEnCours: "Cutting the video (MP4 copy, no re-encode)…",
