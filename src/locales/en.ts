export const en = {
  translation: {
    ...
    navDesc: {
      ...
      upwork: "Upwork missions and contracts (read-only)",
    },
    ugc: {
      personas: {
        title: "UGC Personas",
    ...
    upwork: {
      title: "Upwork",
      subtitle: "{{org}} snapshot — read-only. Sends happen in the Cursor agent.",
      syncTitre: "Agent's last run",
      syncQuand: "On {{date}}",
      syncJamais: "No sync yet — the Cursor automation (every 2 hours) fills this table.",
      syncOk: "OK",
      syncKo: "Failed",
      kpiJobHm: "HM jobs to fill",
      kpiHmPoste: "HMs in seat",
      kpiJobCrea: "Creator jobs",
      kpiCreaRetard: "Creators behind",
      kpiOuvertes: "Open missions",
      kpiHm: "HMs",
      kpiCreateurs: "Creators",
      kpiJobHmOuverts: "Open HM jobs",
      kpiJobCreaOuverts: "Open creator jobs",
      paysKpiPersonnes: "{{hm}} HMs · {{crea}} creators",
      paysKpiJobs: "{{hm}} open HM jobs · {{crea}} open creator jobs",
      retourDash: "All countries",
      ...
      phase2Avant: "The HM posts the creator job from the Upwork account.",
      phase2Aide:
        "Read-only. The HM posts the job from the Upwork account, talks to creators, sends contracts and creates access. You watch, you don’t act.",
      phase3: "Phase 3 — Account watch",
      phase3Avant: "After the creator job is posted.",
      phase3Vide: "As soon as a creator publishes a first post, they move here.",
      phase3Aide: "Read-only. Alert if the last-10-day pace is under 80% or avg views are under 500.",
      phase3Moyenne: "Team average",
      phase3Posts: "Posts 10d",
      phase3Vues: "Views on last 10 posts",
      phase3VuesVal: "{{vues}}",
      phase3VuesMoy: "{{n}} avg views",
      phase3Ratio: "{{posts}} / {{prevus}}",
      phase3Elo: "ELO",
      phase3Alerte: "Below threshold",
      statsPost:
        "{{inv}} invited · {{opp}} opportunities in progress · {{appl}} applicants · {{hired}} hired",
      approcheVide: "Nobody has replied yet.",
      lienUpwork: "Upwork link",
      lienJob: "View job",
      statutHired: "Hired",
      ...
      timeline: {
        ...
        acces_envoyes: "Access sent: Slack + email request + OS codes",
        integration: "Joined",
        job_createur_poste: "Creator job posted",
        tiktok_cree: "TikTok account created",
        warmup: "Warmup active",
        premier_post: "First post",
        check: {
          os: "Joined the OS",
          slack: "Joined Slack",
          upwork: "Added to my Upwork account",
        },
      },
      voirPlus: "Show the chain",
      voirMoins: "Collapse",
      avancement: "{{n}}/{{max}}",
      etapeCourante: "current",
      toutFait: "All done",
      personnesRepondu: "{{n}} people",
      source: {
        os: "OS",
        slack: "Slack",
        upwork: "Upwork",
      ...
      accesAutoAide:
        "Automatic: once the contract is signed, the OS creates the account, writes the message (Slack link to click, OS email + password, email request) and queues it. If it was already sent by hand, tick the step.",
      slackInviteTitre: "Slack managers link",
      slackInviteAide:
        "Included as-is in the HM access message, with the OS codes. You can also tick the step by hand if it was already sent.",
      ...
      actionCopie: "Copied",
      actionDepuis: "requested on {{date}}",
      action: {
        arreter_recrutement: "Stop recruiting",
      ...
      candidatsDecides: "{{n}} profile(s) already decided",
      candidatValider: "Approve",
      candidatRefuser: "Reject",
      candidatAuto: "approved by timeout",
      autoDans: "auto-invite in {{h}} h",
      autoMaintenant: "goes out next run",
      candidatStatut: {
        propose: "to approve",
        valide: "approved",
        refuse: "rejected",
      ...
      promptsTitre: "Prompts ready for the agent",
      promptsVide: "No pending action.",
      promptsAide: "Picked up automatically on the agent's next run (every 2 hours).",
      kpiHmJobs: "Open HM jobs",
      kpiNew: "New applicants",
      kpiContrats: "Active contracts",
      kpiL2: "No post ≥ 2 days",
      kpiL1: "Not posted today",
      marcheDesc: "The four objects in this market — not the Upwork listing.",
      objet: {
        hm: "HM",
        jobHm: "HM job",
        jobCreateur: "Creator job",
        createur: "Creator",
      },
      hmVide: "No one in seat.",
      jobHmVide: "No job to hire a HM.",
      jobHmPourvu: "Filled — {{nom}} · job still live ({{inv}} invited, {{appl}} applicants). ",
      jobCreaVide: "The HM has not posted the job from the Upwork account yet.",
      jobCreaAvantHm: "Not before a HM is in place.",
      createursVide: "No creator attached.",
      createursOk: "{{n}} creator(s), none behind.",
      faitsMission: "{{appl}} applicants · {{inv}} invited · {{msg}} questions · {{hired}} hired",
      slackOk: "Slack",
      slackKo: "Not in Slack",
      osOk: "OS",
      osKo: "Not signed in",
      nbCreateursHm: "{{n}} creator(s)",
      etapeVide: "not yet",
      etapeFait: "done",
      prochaine: "Next step",
      pipelineTitre: "Pipeline",
      pipelineCheminJob: "job → invited → questions → contract",
      pipelineCheminHm: "contract → Slack → OS codes → signed into OS → creators",
      pipelineChemin:
      ...
      ouvertesOn: "Open only",
      ouvertesOff: "All statuses",
      vide: "Nothing to show.",
      videAlertes: "No accounts behind.",
      colTitre: "Mission",
      colStatut: "Status",
      colAppl: "Applicants",
      colNew: "New",
      ...
      lieOs: "Linked",
      pasLie: "Unlinked",
      l2: "Level 2 — 2 days or more",
      l1: "Level 1 — nothing today",
      jours: "{{n}} d",
      sansHm: "No HM",
    },
  },
