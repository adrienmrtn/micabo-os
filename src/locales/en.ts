export const en = {
  translation: {
    ...
    bibliotheque: {
      ...
      nettoyageEchec: "Cleaning didn't succeed (Gemini overloaded, or image too text-heavy). Retry, or delete the photo.",
    ...
    testNet: {
      title: "Cleaning test",
      subtitle:
        "Uncleaned photos from each account. Click \"Test\" to see how cleaning looks, without changing anything. \"Test all\" runs the batch 2 by 2 (the proxy saturates beyond that).",
    ...
    adminPost: {
      ...
      lotAide: "Each photo takes ~1 min; 3 are processed in parallel. You can let it run.",
