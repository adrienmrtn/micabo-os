export const en = {
  translation: {
    ...
    navDesc: {
      ...
      papier: "Daily papercraft master: duration, voices, pause and Fal quota",
    ...
    papier: {
      ...
      assigner: "Assign to CM accounts",
      assignerAide: "The same video per language, for every active CM account in that language.",
    ...
    reglages: {
      ...
      actionPapierDesc:
        "Daily papercraft video: duration, ElevenLabs voices, auto pause, Fal cap.",
      papierPause: "Pause paper (cron + auto-chain)",
      papierPauseAide:
        "Midnight no longer starts the master. Buttons on /admin/papier still work. The Fal quota still applies.",
