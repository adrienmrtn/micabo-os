export const en = {
  translation: {
    ...
    chatbot: {
      ...
      widgetSous: "Answers from admin docs",
      ouvrir: "Help",
      greeting: "Ask your question. I only answer from what the admin put in the docs.",
      ...
      contextSubtitle:
        "Notes, rules, FAQ — this is what the assistant uses, on top of the published guides.",
      nouveau: "Add a note",
