export const en = {
  translation: {
    ...
    upwork: {
      ...
      missionsTitre: "Open missions",
      missionsDesc: "PUBLISHED jobs only — no cancelled / filled / draft. Flag = target country.",
      contratsTitre: "Hiring managers",
      contratsDesc: "What’s going on, the facts, and the pipeline with timestamps.",
