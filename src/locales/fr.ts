export const fr = {
  translation: {
    ...
    creation: {
      ...
      elo: "Note de départ",
      eloAide: "Défaut 65 → tier A. <50 D · 50–55 C · 55–60 B · 60–70 A · 70–80 S · ≥80 S+.",
    ...
    prompts: {
      ...
      ugcVideoCaptionDesc:
        "Légende TikTok traduite dans la langue du créateur — jamais « micabo », oriente vers l’appli (partie utilisation).",
