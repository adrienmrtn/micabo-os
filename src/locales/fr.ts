export const fr = {
  translation: {
    ...
    upwork: {
      ...
      missionsTitre: "Missions en cours",
      missionsDesc: "Jobs PUBLISHED seulement — pas les cancelled / filled / draft. Drapeau = pays cible.",
      contratsTitre: "Hiring managers",
      contratsDesc: "Ce qui se passe, les faits, et le pipeline avec les horaires.",
