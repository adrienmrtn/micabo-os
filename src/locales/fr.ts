export const fr = {
  translation: {
    ...
    simPapier: {
      ...
      subtitle:
        "Pioche un master FR pas encore utilisé dans la langue de UN compte CM, en test. Invisible sur les calendriers.",
      compte: "Compte CM",
    ...
    papier: {
      title: "Papier CM",
      subtitle:
        "Bibliothèque de masters FR complets (voix + karaoké). Les autres langues se créent à minuit, seulement s’il y a un compte CM.",
      aujourdHui: "Master en cours",
      aujourdHuiAide:
        "Avancer le pipeline prépare un master FR pour la bibliothèque — pas le soir même. À minuit chaque CM pioche un master pas encore utilisé dans sa langue.",
      aucunAujourdhui: "Aucun master en cours. Lance-en un pour la bibliothèque.",
      topic: "Sujet",
      topicPh: "Laisser vide pour qu’un sujet soit proposé automatiquement.",
      generer: "Avancer le pipeline",
      avancer: "Avancer le pipeline",
      relancer: "Relancer (garder les assets)",
      regenerer: "Regénérer depuis zéro",
      historique: "Bibliothèque",
      biblioAide:
        "Masters FR complets (script, clips, voix, karaoké). À minuit chaque CM pioche un master pas encore utilisé dans sa langue.",
      vide: "Aucun master FR en bibliothèque.",
      enBiblio: "En bibliothèque",
      languesDemande: "Langues créées à l’assignation",
      videoFr: "Vidéo FR",
      consommees: "Déjà servi : {{langues}}",
      aucuneConso: "Pas encore servi à un CM",
      ...
      languesAide: "Une langue naît quand un CM de cette langue pioche ce master. Pas de fan-out à l’avance.",
      relancerLangue: "Relancer",
      assigner: "Assigner maintenant (minuit)",
      assignerAide:
        "Chaque CM actif pioche un master pas encore utilisé dans sa langue. Si la voix manque, elle se génère. Si plus rien : un original démarre.",
