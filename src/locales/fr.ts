  ...
  translation: {
    ...
    ugc: {
      ...
      videos: {
        ...
        cropAide:
          "Coupe le début et la fin. Le trim est fait côté serveur (copie FPS/qualité TikTok) — la vidéo entière n’est que temporaire.",
        ...
        cropEnCours: "Trim serveur (sans recodage navigateur)…",
