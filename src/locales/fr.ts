export const fr = {
  translation: {
    ...
    navDesc: {
      ...
      papier: "Master quotidien papier : durée, voix, pause et quota Fal",
    ...
    papier: {
      title: "Papier CM",
      subtitle:
        "Une vidéo papercraft par jour : master FR, puis 14 langues (traduction, voix ElevenLabs, karaoke).",
      aujourdHui: "Aujourd’hui — {{date}}",
      aujourdHuiAide:
        "Le cron de minuit lance le master. Tu peux forcer un sujet ou relancer un échec.",
      aucunAujourdhui: "Aucun master pour aujourd’hui. Lance la génération.",
      topic: "Sujet du jour",
      topicPh: "Laisser vide pour qu’un sujet soit proposé automatiquement.",
      generer: "Générer le master",
      avancer: "Avancer le pipeline",
      relancer: "Relancer (garder les assets)",
      regenerer: "Regénérer depuis zéro",
      historique: "Derniers masters",
      vide: "Aucun master encore.",
      ...
      langues: "Langues",
      languesAide: "Même clips visuels, voix et captions par langue.",
      avancerLangues: "Avancer les langues",
      relancerLangue: "Relancer",
      assigner: "Assigner aux comptes CM",
      assignerAide: "La même vidéo par langue, pour tous les CM actifs de cette langue.",
    ...
    reglages: {
      ...
      actionPapierDesc:
        "Vidéo papercraft du jour : durée, voix ElevenLabs, pause auto, plafond Fal.",
      papierPause: "Mettre le papier en pause (cron + auto-chaîne)",
      papierPauseAide:
        "Minuit ne lance plus le master. Les boutons de /admin/papier restent actifs. Le quota Fal continue de s’appliquer.",
      papierDuree: "Durée",
