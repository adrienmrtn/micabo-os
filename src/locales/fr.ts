export const fr = {
  translation: {
    ...
    chatbot: {
      ...
      widgetSous: "Réponses à partir des docs admin",
      ouvrir: "Aide",
      greeting: "Pose ta question. Je réponds uniquement avec ce que l'admin a mis dans les docs.",
      ...
      contextSubtitle:
        "Textes, consignes, FAQ — c'est tout ce que l'assistant utilise, en plus des guides déjà publiés.",
