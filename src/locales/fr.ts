export const fr = {
  translation: {
    ...
    navDesc: {
      ...
      upwork: "État des missions et contrats Upwork (lecture seule)",
    },
    ugc: {
      personas: {
        title: "Personas UGC",
    ...
    upwork: {
      title: "Upwork",
      subtitle: "État des lieux {{org}} — lecture seule. Les envois se font dans l’agent Cursor.",
      syncTitre: "Dernier passage de l’agent",
      syncQuand: "Le {{date}}",
      syncJamais: "Aucune sync pour l’instant — l’automation Cursor (toutes les 2 h) remplit ce tableau.",
      syncOk: "OK",
      syncKo: "Échec",
      kpiJobHm: "Jobs HM à pourvoir",
      kpiHmPoste: "HM en poste",
      kpiJobCrea: "Jobs créateurs",
      kpiCreaRetard: "Créateurs en retard",
      kpiOuvertes: "Missions ouvertes",
      kpiHm: "HM",
      kpiCreateurs: "Créateurs",
      kpiJobHmOuverts: "Jobs HM ouverts",
      kpiJobCreaOuverts: "Jobs créateurs ouverts",
      paysKpiPersonnes: "{{hm}} HM · {{crea}} créateurs",
      paysKpiJobs: "{{hm}} job HM ouvert · {{crea}} job créateurs ouvert",
      retourDash: "Tous les pays",
      sectionJobHm: "Job posts HM",
      sectionJobCrea: "Job posts créateurs",
      phase1: "Phase 1 — Contacté → job créateurs posté",
      phase2: "Phase 2 — Recrutement des créateurs",
      phase2Progress: "{{n}} / {{max}} créateurs",
      phase2Avant: "Le HM poste le job créateurs depuis le compte Upwork.",
      phase2Aide:
        "Lecture seule. C’est le HM qui poste le job depuis le compte Upwork, parle aux créateurs, envoie les contrats et crée les accès. Tu regardes, tu ne fais rien.",
      phase3: "Phase 3 — Surveillance des comptes",
      phase3Avant: "Après le job créateurs.",
      phase3Vide: "Dès qu’un créateur a publié son premier post, il passe ici.",
      phase3Aide: "Lecture seule. Alerte si le rythme des 10 derniers jours < 80 % ou les vues moy. < 500.",
      phase3Moyenne: "Moyenne de l’équipe",
      phase3Posts: "Posts 10 j.",
      phase3Vues: "Vues 10 derniers posts",
      phase3VuesVal: "{{vues}}",
      phase3VuesMoy: "{{n}} vues moy.",
      phase3Ratio: "{{posts}} / {{prevus}}",
      phase3Elo: "ELO",
      phase3Alerte: "Sous le seuil",
      statsPost:
        "{{inv}} invités · {{opp}} opportunités en cours · {{appl}} candidatures · {{hired}} embauchés",
      approcheVide: "Personne n’a encore répondu.",
      lienUpwork: "Lien Upwork",
      lienJob: "Voir le job",
      ...
      timeline: {
        ...
        acces_envoyes: "Accès envoyés : Slack + demande email + codes OS",
        integration: "A rejoint",
        job_createur_poste: "Job créateurs posté",
        tiktok_cree: "Compte TikTok créé",
        warmup: "Warmup actif",
        premier_post: "Premier post",
        check: {
          os: "Rejoint l’OS",
          slack: "Rejoint Slack",
          upwork: "Ajoutée à mon compte Upwork",
        },
      },
      voirPlus: "Voir le déroulé",
      voirMoins: "Replier",
      avancement: "{{n}}/{{max}}",
      etapeCourante: "en cours",
      toutFait: "Tout est fait",
      personnesRepondu: "{{n}} personne(s)",
      source: {
        os: "OS",
        slack: "Slack",
        upwork: "Upwork",
      ...
      promptsAide: "Pris automatiquement au prochain passage de l’agent (toutes les 2 h).",
      kpiHmJobs: "Jobs HM ouverts",
      kpiNew: "Nouvelles candidatures",
      kpiContrats: "Contrats actifs",
      kpiL2: "Sans post ≥ 2 jours",
      kpiL1: "Pas posté aujourd’hui",
      marcheDesc: "Les 4 objets du marché — pas le listing Upwork.",
      objet: {
        hm: "HM",
        jobHm: "Job HM",
        jobCreateur: "Job créateurs",
        createur: "Créateur",
      },
      hmVide: "Personne en poste.",
      jobHmVide: "Pas de job pour recruter un HM.",
      jobHmPourvu: "Pourvu — {{nom}} · le job est encore ouvert ({{inv}} invités, {{appl}} candidatures). ",
      jobCreaVide: "Le HM n’a pas encore posté le job depuis le compte Upwork.",
      jobCreaAvantHm: "Pas avant d’avoir un HM.",
      createursVide: "Aucun créateur rattaché.",
      createursOk: "{{n}} créateur(s), aucun en retard.",
      faitsMission: "{{appl}} candidatures · {{inv}} invités · {{msg}} questions · {{hired}} embauchés",
      slackOk: "Slack",
      slackKo: "Pas Slack",
      osOk: "OS",
      osKo: "Pas connectée",
      nbCreateursHm: "{{n}} créateur(s)",
      etapeVide: "pas encore",
      etapeFait: "fait",
      prochaine: "Prochaine étape",
      pipelineTitre: "Pipeline",
      pipelineCheminJob: "job → invités → questions → contrat",
      pipelineCheminHm: "contrat → Slack → codes OS → connectée OS → créateurs",
      pipelineChemin:
        "job → invités → questions → contrat → Slack → codes OS → connectée OS → créateurs",
      pipelineCheminCreateur: "job → invités → questions → contrat",
      etape: {
        job: "Job posté",
        invites: "Invités",
        questions: "Questions",
      ...
      ouvertesOn: "Ouvertes seulement",
      ouvertesOff: "Toutes les statuts",
      vide: "Rien à afficher.",
      videAlertes: "Aucun compte en retard.",
      colTitre: "Mission",
      colStatut: "Statut",
      colAppl: "Candidats",
      colNew: "Nouveaux",
      ...
      lieOs: "Lié OS",
      pasLie: "Pas lié",
      l2: "Niveau 2 — 2 jours ou plus",
      l1: "Niveau 1 — rien aujourd’hui",
      jours: "{{n}} j",
      sansHm: "Sans HM",
    },
  },
