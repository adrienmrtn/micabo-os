...
/** Bloc d'état vide : même gabarit partout pour que l'absence de données ne
 *  ressemble jamais à un bug de chargement. */
export function EmptyState({
  ...
  return (
    <Empty className="rounded-xl border border-dashed py-12 md:py-12">
      <EmptyHeader>
