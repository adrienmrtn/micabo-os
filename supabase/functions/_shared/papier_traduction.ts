...
Traduis ce script de vidéo courte TikTok (papercraft / révisions, flashcards) en ${cible}.
...
INTERDIT : culture générale, nom d'un autre produit.

${rules?.trim() ? `Règles supplémentaires :\n${rules.trim()}\n` : ""}
RÈGLE micabo : le mot « micabo » (nom de l'appli, minuscules, ne pas traduire) apparaît EXACTEMENT UNE FOIS, uniquement dans le CTA. Ailleurs dis l'équivalent local de « l'appli ».
